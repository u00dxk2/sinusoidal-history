...
Modelski's long cycle of world leadership (period stated as 100–120 years; we plot 110) is about the rise and decline of a single world power's preponderance — Portugal, the Netherlands, Britain (twice), then the United States, with the US cycle's ascent consolidated in 1945. Relative economic size of the leading state is the most data-tractable proxy for that preponderance — a proxy for a *correlate* of Modelski's construct (economic size), not the construct itself (sea power, global reach). Modelski and Thompson's own seapower concentration series (*Seapower in Global Politics, 1494–1993*, 1988) exist as a book, not as a digitized public dataset with reuse terms, while Maddison GDP is both. The series' all-time maximum is **31.577% in 1945** — the same year as the cycle's reference peak. Under a denominator whose country coverage is thinnest early and whose components are forward-filled, that coincidence is descriptive, not independent validation of the theory. Both structural minima sit at leadership crossovers (15.941% in 1881, at the China→US handoff; 16.092% in 2013, just before the US→China handoff), which is at least consistent with the theory's claim that transitions happen when preponderance is lowest.

Leading-power timeline the data actually shows: **China 1870–1881, United States 1882–2013, China 2014–2022.**

## Caveats

- **The denominator is the summed GDP of the countries Maddison covers in that year, not an upstream world total.** The series name says "world GDP" for consistency with the sibling US-share series; read both as shares of the covered-country sum, which grows over time (see the pre-1950 bias below).
- **Forward-filling between sparse benchmarks creates flat plateaus and step changes at observation years**, and those features can carry low-frequency structure of their own. The series sits below the spectral eligibility gate (1.4 of 3.0 periods), so no primary verdict rests on it, but the cross-grid cells that re-pair other periods with this series inherit the artifact.
