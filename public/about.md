...
### Schlesinger Jr. — liberal/conservative cycle

- **Period:** 30 years
- **Reference peak:** 1970
- **Page:** https://sinusoidalhistory.com/cycles/schlesinger-jr

~30-year alternation of American politics between 'public purpose' (liberal/reform) and 'private interest' (conservative/consolidation) eras; the phase lengths are historical approximations of roughly 15–17 years, not fixed half-waves

*Peak calibration:* Midpoint of the most recently completed liberal era in the conventional tabulation of Schlesinger Jr.'s scheme (1962–1978). The midpoint is this project's construction, not a peak date Schlesinger states. Taking the midpoints of his dated liberal eras gives roughly 1910 (Progressive), 1939 (New Deal), and 1970 (1960s/Great Society) - intervals of 29 and 31 years, averaging 30 - which is where the 30-year period comes from. The framework descends from Arthur Schlesinger Sr., whose *Paths to the Present* (1949) tabulated eleven alternating liberal and conservative periods through 1947 averaging 16.55 years each, implying a same-mood recurrence nearer 33 years; his son's streamlined twentieth-century scheme runs closer to 30, and 30 is what is plotted. Note: Schlesinger Jr. himself expected the next liberal turn shortly before or after 1990; a strict 30-year clock from 1970 puts the next cosine peak at 2000. His own forecast and his own period disagree - a plain demonstration of how sensitive a fixed sinusoid is to the anchor and period chosen.
...
*Caveat:* US-only periodization; like Huntington and Strauss-Howe, this is interpretive history, not measurement. Schlesinger's own ~1990 forecast for the next liberal turn does not align with the 30-year-from-1970 sinusoid - read the curve as a stylization of his stated period, not as Schlesinger's own prediction. The paired Stimson series measures mass preferences over the scope of domestic government - one component of his public-purpose/private-interest rhythm, not the whole of it.
...
*Peak calibration:* Start of the US world-power phase in Modelski's own dating: Table 2.1 of *Long Cycles in World Politics* (1987, p. 40) dates the American cycle's phases 1914–1945 (global war) and 1945–1973 (world power), and Table 2.2 (p. 42) dates US oceanic supremacy from 1944, when the US crossed his threshold of one-half of the world's capital-ship assets. The 110-year period is this project's midpoint of the '100 to 120 years' range Modelski states in his encyclopedia treatment ('Long Cycles in Global Politics,' UNESCO-EOLSS), where he also warns that the long cycle 'does not connote strict cycles' - treat the fixed sinusoid as a stylization he explicitly disclaims. The 1987 book brackets the same range: it reports that 'in four of the cases, the average interval of time between the attainment of naval preponderance by one power and by its successor is 120 years' (p. 42) and speaks of 'the recurrence of global wars at intervals of about one century' (p. 218). Anchored at 1945, a 110-year cosine puts its earlier peaks at 1835, 1725, 1615, and 1505, against Modelski's own world-power phase starts of 1815 (Britain II), 1714 (Britain I), 1609 (the Netherlands), and 1516 (Portugal): misses of +20, +11, +6, and −11 years. The fixed period reproduces his sequence only loosely, and the drift grows toward the present.

*Source:* George Modelski, *Long Cycles in World Politics* (Macmillan / University of Washington Press, 1987); period range and non-strict-cycles disclaimer from Modelski, 'Long Cycles in Global Politics,' UNESCO-EOLSS.
...
*Peak calibration:* Most recent stated peak, in Turchin's own words: 'a 50-year oscillation superimposed on the secular cycle, with peaks around 1870, 1920, and 1970' (*Journal of Peace Research* 49(4), 2012). With period 50 and peak 1970, this sinusoid's prior peaks land exactly on his other two stated peaks (1870 and 1920) and the next lands at 2020. Turchin himself extends the sequence to 'around 2020' in the same paper, while explicitly calling that a simple projection rather than a scientific prediction; it also coincides with the instability forecast of his separate 150-year secular cycle, so the two Turchin curves on this site peak together at 2020 by construction, not as corroboration. The paper attributes the mechanism to the 'fathers-and-sons' dynamic - an additional process he treats as distinct from the core structural-demographic theory - and prefers the term 'bi-generation cycles,' with recurrence 'roughly two generations (40–60 years)'; 50 is the headline number and the one used here.
...
*Caveat:* Same author as the 150-year secular cycle - a distinct construct from a distinct paper, not independent corroboration. Turchin describes the observed ~50-year pattern as sharply peaked, not sinusoidal; the cosine here keeps only his recurrence interval and reference peaks, not his waveform. No paired data series: Turchin posts the underlying US Political Violence Database (USPVD2010.xlsx; 1,590 events, 1780–2010) on his site, but it carries no explicit reuse license, so this site does not redistribute it.

## Intellectual-honesty disclaimer

All ten cycles are contested in different ways. Kondratiev waves have never been cleanly confirmed in empirical long-run data; spectral analyses report some weak periodicity, but period, phase dating, and existence are not agreed across studies. Khaldun wrote in the 14th century about dynastic politics in a Maghrebi context; applying his framework to a modern US-and-global axis is this project's choice. Huntington's creedal-passion cycle is an interpretive lens over American politics, not a measurement. Perez's techno-economic paradigm framework is rich and influential but methodologically qualitative - Schumpeterian historical pattern recognition, not statistical fitting. (An earlier draft of this site mistakenly labeled it "quantitative.")

Turchin's secular cycles have the most developed quantitative literature of the ten, but the 150-year period for the modern American cycle is a fitted parameter. Dalio's Big Cycle is a popularised composite, not a peer-reviewed measurement, and his own stated peak year for US power is the 1950s, not 1945 (we use 1950). Strauss-Howe is generational theory - influential in popular discourse, contested in academic history; reducing their four-turnings saeculum to a single sinusoid forces the choice of which peak to anchor (we use the post-WWII High at ~1955). With period 84, the trough of this construction lands at 1997 and the next peak at 2039; their predicted Crisis climax around 2020 sits on the rising arm of the sinusoid (cos ≈ +0.15), neither at a trough nor a peak - there is no peak-year anchor that aligns the predicted Crisis climax with either a sinusoid peak or trough. Schlesinger Jr.'s liberal/conservative cycle is interpretive periodization formalizing his father's alternating phases (averaging 16.55 years in the elder Schlesinger's count) into a ~30-year full cycle; the empirical pairing (Stimson Policy Mood) only covers 1952 onward, so the Schlesinger curve's pre-1952 shape cannot be stress-tested against the data. Modelski's long cycle is a 100–120-year range that he says "does not connote strict cycles"; we plot a fixed 110-year sinusoid he would disclaim, paired with a largest-economy series that is a proxy for a correlate of his naval construct, not the construct itself. Turchin's fathers-and-sons cycle is a three-peak claim (1870, 1920, 1970) from a single 2012 paper by the same author as the 150-year secular cycle - not independent corroboration - and its observed pattern is sharply peaked, not sinusoidal. Four cycles (Schlesinger Jr., Strauss-Howe, Modelski, and Turchin fathers-and-sons) carry an inline caveat surfaced in the focused-facet view; treat those caveats as part of the claim.
